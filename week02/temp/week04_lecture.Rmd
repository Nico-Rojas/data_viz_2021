...
background-image: url(images/rio_olympics.jpg)
background-size: 135%
background-position: 20% 0%

# Assignment 1

- Posted on Github. Due next week.  
- Submission guidelines on Github as well. 
...
Please send questions / suggestions on piazza!
...
Currently 104 htmlwidgets featured on http://www.htmlwidgets.org/  
...
<!-- https://trends.google.com/trends/explore?date=2011-01-01%202019-02-15&q=plotly,shiny%20R,d3.js ---> 
...
The [chartmaker directory](http://chartmaker.visualisingdata.com/) on Andy Kirk's website [visualisingdata.com](visualisingdata.com) allows you to find the right tool for the job.
